#pragma once
#ifndef PETRICHOR_TEST_FIXTURES_COMMON_CREATION_FUNCTIONS_HPP
#define PETRICHOR_TEST_FIXTURES_COMMON_CREATION_FUNCTIONS_HPP
...
#endif //!PETRICHOR_TEST_FIXXTURES_COMMON_CREATION_FUNCTIONS_HPP